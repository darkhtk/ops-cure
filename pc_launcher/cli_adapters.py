...
class BaseCliAdapter:
    ...
    def prepare_input(self, context: AdapterContext) -> str:
        ...
        return (
            ...
            "[[/report]]\n"
            "- Use this exact format when directly answering the operator's question:\n"
            "[[answer]]\n"
            ...
            "[[discuss type=\"reply\" to=\"planner\" anomaly=\"A-001\"]]\n"
            "Short diagnosis and next action.\n"
            "[[/discuss]]\n"
            "- Close or escalate a discussion like this:\n"
            "[[discuss type=\"resolve\" anomaly=\"A-001\"]]\n"
            "Short resolution.\n"
            "[[/discuss]]\n"
            "[[discuss type=\"escalate\" anomaly=\"A-001\"]]\n"
            "Short reason this still needs operator or planner attention.\n"
            "[[/discuss]]\n"
