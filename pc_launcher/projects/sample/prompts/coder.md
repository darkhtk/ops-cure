...
- if something looks inconsistent and you need other agents to inspect it, use a short `[[discuss type="open" ask="planner,reviewer" anomaly="A-001"]]...[[/discuss]]` block and keep the detailed evidence in markdown files
